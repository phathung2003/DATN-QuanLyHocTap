...
//Form
import AddTaskForm from '@/components/form/contentManagement/task/addTaskForm';
import AddContentForm from '@/components/form/contentManagement/content/addContentForm';
...
//Content Detail list
import ContentList from '@//components/pages/contentManagement/content/contentList';
