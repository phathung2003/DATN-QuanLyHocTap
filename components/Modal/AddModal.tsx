...
const AddModal: React.FC<AddModalProps> = ({
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className="fixed inset-0 z-9999 flex h-full w-full items-center justify-center bg-slate-200 bg-opacity-40"
    >
      <div className="relative max-h-full w-full max-w-[750px] rounded-xl bg-white p-4 shadow-lg dark:bg-slate-800 sm:p-5">
