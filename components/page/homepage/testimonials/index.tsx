...
import SingleTestimonial from '@/components/page/homepage/testimonials/SingleTestimonial';
...
const Testimonials = () => {
  return (
    <section className="relative z-10 bg-[#FFEFEF] px-20 py-8 dark:bg-slate-800 md:py-12 lg:py-16">
