...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="relative overflow-hidden bg-white px-20 pb-16 pt-[120px] dark:bg-black md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
      >
                ...
                <defs>
                  ...
                  >
                    <stop
                      ...
                      stopOpacity="0"
                    />
                    <stop offset="1" stopColor="#FF69B4" stopOpacity="0.08" />
                  </radialGradient>
                  <radialGradient
              ...
              >
                ...
                <defs>
                  <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop stopColor="#FF69B4" stopOpacity="0" />
            ...
            <div className="mx-auto max-w-screen-xl">
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3">
                {cards.map((card, index) => (
                  <div
                    key={index}
                    className="relative flex w-full items-end justify-start bg-cover bg-center text-left duration-500 hover:scale-105 hover:shadow-xl"
                    style={{
                      height: '450px',
                      backgroundImage: `url(${card.imageUrl})`,
                    }}
                  >
                    <div className="to-gray-900 absolute bottom-0 left-0 right-0 top-0 mt-20 bg-gradient-to-b from-transparent"></div>
