const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div
        className="wow fadeInUp shadow-three dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark hover:shadow-one relative z-10 rounded-sm bg-white px-8 py-10"
        data-wow-delay=".1s"
      >
