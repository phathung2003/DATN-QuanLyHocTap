...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-[#FFEFEF] px-10 pt-16 dark:bg-slate-900 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          ...
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#FF69B4" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#FF69B4" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#FF69B4" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
