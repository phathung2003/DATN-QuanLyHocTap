...
const DetailButton: React.FC<DetailButtonProperties> = ({
  ...
  return (
    <Link id="detail_Button" href={link}>
      <button className="inline-flex w-max items-center justify-center gap-2.5 rounded-lg bg-yellow-600 px-2 py-2 text-xs font-medium text-white hover:bg-yellow-700">
